...
-- 사원정보
INSERT INTO employee (id, code, name, department_code, job_position_code, job_type_code, status)
VALUES
(1, 1001, '김경민', 101, 201, 301, '재직'),
(2, 1002, '박영훈', 102, 202, 301, '재직'),
(3, 1003, '이민영', 103, 203, 301, '퇴사'),
(4, 1004, '정수진', 101, 203, 301, '재직'),
(5, 1005, '송미라', 102, 203, 301, '재직'),
(6, 1006, '홍길동', 103, 203, 301, '재직'),
(7, 1007, '김철수', 101, 203, 301, '퇴사'),
(8, 1008, '이영희', 102, 203, 301, '재직'),
(9, 1009, '박지성', 103, 203, 301, '재직'),
(10, 1010, '최민수', 101, 203, 301, '재직'),
(11, 1011, '강다혜', 102, 203, 301, '퇴사'),
(12, 1012, '임성준', 103, 203, 301, '재직'),
(13, 1013, '윤지원', 101, 203, 301, '재직');
